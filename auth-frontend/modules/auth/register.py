...
def get():
        ...
        Div(
            ...
            Div(
                Form(
                    ...
                    Label("Usuario"),
                    Input(
                        type="text", name="username", id="input_username", required=True
                    ),
                    Label("Password"),
                    Input(
    ...
    return Layout(
        "Crear", ["/styles/login.css"], ["/scripts/register.js"], body
    ).render()
        ...
        return JSONResponse(
            {
                ...
                "detail": {"password_verify": "Las contrasenias no coiciden."},
            },
            status_code=400,
        )
                ...
                return JSONResponse(
                    {
                        ...
                        "detail": {"userNameExist": json_data["username"][0]},
                    },
                    status_code=400,
                )
            else:
                return JSONResponse(
                    {
                        "error": "Error de registro!!!",
                        "detail": {
                            "Unkown": "error desconocidom, comuniquese con el admin"
                        },
                    },
                    status_code=400,
                )
